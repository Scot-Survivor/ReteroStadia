"""
Django settings for RetroStadia project.
...
WSGI_APPLICATION = 'RetroStadia.wsgi.application'
...
# Password Hashes
# https://docs.djangoproject.com/en/4.2/topics/auth/passwords/#password-hash-algorithms
PASSWORD_HASHERS = [
